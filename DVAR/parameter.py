...
parser.add_argument('--path', type=str, default=DATA_PATH+"/meta.path" ,help="input_path")
parser.add_argument('--output_file', default=DATA_PATH+"/m2v.emb", type=str, help='output_file')
...
parser.add_argument('--data_path', type=str, default=DATA_PATH, help="data_files/ml for ml and data_files/amazon for amazon")
